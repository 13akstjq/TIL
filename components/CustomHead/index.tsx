  ...
  if (type === "post" && post) {
    ...
    return (
      <Head>
        ...
        <meta property="og:image" content={`/${SITE_NAME}/favicons/ms-icon-310x310.png`} data-gatsby-head="true" />
        <meta property="og:locale" content={LANG_LOCALE[lang]} data-gatsby-head="true" />
        ...
        <meta name="twitter:image" content={`/${SITE_NAME}/favicons/ms-icon-310x310.png`} data-gatsby-head="true" />
        <meta name="twitter:data1" content={`Dev | ${SITE_NAME}`} data-gatsby-head="true" />
      </Head>
    );
  }
